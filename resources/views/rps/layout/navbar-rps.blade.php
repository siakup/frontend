<div class="navigation-rps-card">
    ...
    <a href="{{ route('rps.rencana-evaluasi-mahasiswa') }}" class="flex items-center item text-center @if (Route::currentRouteName() === 'rps.rencana-evaluasi-mahasiswa') active @endif">Rencana Evaluasi Mahasiswa</a>
    <a href="{{ route('rps.submission') }}" class="flex items-center item text-center @if (Route::currentRouteName() === 'rps.submission') active @endif">Submission</a>
</div>
