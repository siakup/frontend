...
<x-container variant="content-wrapper">
    ...
    <div class="rps-content p-5 flex flex-col gap-5" >
        <x-container variant="content-wrapper" class="flex flex-row justify-between py-2">
            <x-typography variant="body-medium-bold" class="self-center">Submit RPS</x-typography>
                <x-button.primary
                    x-on:click="$dispatch('open-modal', {id: 'preview-rps'})"
                >
                    Pratinjau
                </x-button.primary>
            </x-container>
            ...
            <x-table>
                <x-table-head>
                    <x-table-row>
                        <x-table-header>Dosen Pengembang RPS</x-table-header>
                        <x-table-header>Ketua Program Studi</x-table-header>
                        <x-table-header>Dekan</x-table-header>
                    </x-table-row>
                </x-table-head>
                <x-table-body>
                    <x-table-row>
