            ...
            <x-form.input-container labelClass="w-[200px]">
                ...
                <x-slot name="input">
                    <div class="flex gap-20">
                        <x-form.checklist x-model="kuliah" :id="'kuliah'" :value="'kuliah_on'" label="Kuliah (K)" :name="'kuliah'"/>
                        <x-form.checklist x-model="diskusi_latihan" :id="'diskusilatihan'" :value="'diskusi_on'" label="Diskusi & Latihan (DL)" :name="'diskusilatihan'"/>
                        <x-form.checklist x-model="tugas" :id="'tugas'" :value="'tugas_on'" label="Tugas (T)" :name="'tugas'"/>
                    </div>
                </x-slot>
            </x-form.input-container>
            <x-form.input-container labelClass="w-[200px]" :labelWrap="true">
