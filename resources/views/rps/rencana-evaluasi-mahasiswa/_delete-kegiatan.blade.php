<x-modal.container id="delete-kegiatan">
    <x-slot name="header" class="items-center bg-gray-200">
        <div class="w-full relative flex items-center justify-center">
            <x-typography variant="heading-h5">Hapus Jadwal Pelaksanaan</x-typography>
    ...
    <x-typography variant="body-small-regular" class="text-center">
       <p>Apakah Anda yakin ingin menghapus jadwal pelaksanaan ini?</p>
    </x-typography>
    <x-slot name="footer">
