...
@section('content')
    <div class="flex flex-col gap-4 p-4 w-full h-full">
        ...
        <x-button.back href="{{ route('rps.rencana-evaluasi-mahasiswa') }}">Rencana Evaluasi Mahasiswa</x-button.back>
            ...
            <div x-data="{bentuk_ujian: ''}" class="flex flex-col gap-5 content-white rounded-b-md p-5">
                ...
                <div class="flex flex-col gap-4 my-5">
                    ...
                    <div class="flex justify-end">
                        <x-button variant="primary" x-on:click="$dispatch('open-modal', {id: 'create-indikator'})">Tambah Indikator dan Kriteria</x-button>
                    </div>
                </div>
