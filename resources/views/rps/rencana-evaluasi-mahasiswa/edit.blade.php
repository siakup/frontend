...
@section('content')
    ...
    <x-container.container x-data variant="content" class="ml-3" borderRadius="rounded-b-xl">
        <x-container.container variant="content" class="flex flex-col gap-3" borderRadius="rounded-xl">
