...
@section('content')
    <x-container.wrapper :gapY="4" :rows="15" x-data="rps()">
        ...
        <x-container.container :background="'content-white'" :padding="'p-5'" class="row-start-2 row-end-16 flex-col" :gap="'gap-5'">
