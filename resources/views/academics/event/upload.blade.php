...
@section('content')
  <x-container.container :variant="'content-wrapper'">
    ...
    <x-container.container :class="'p-4 flex flex-col items-start gap-2.5 self-stretch'">
      <x-container.container :variant="'content-wrapper'" class="flex flex-row !mx-0 !px-0 !w-max items-center">
      ...
      <x-container.container :variant="'content-wrapper'" class="flex flex-row gap-10 justify-between !px-0">
        <x-container.container :variant="'content-wrapper'" class="basis-[35%] shrink-0 grow-0 min-w-1/5 max-w-[35%] flex flex-col !gap-2 !px-0">
          ...
          <x-container.container :variant="'content-wrapper'" class="grow-1 shrink-1 basis-0 min-w-3/4 flex flex-col !mx-0 !px-0 !gap-4 relative items-start w-full">
      ...
      <x-container.container class="flex flex-col !p-5 !gap-2.5 !bg-[#FAFAFA]">
