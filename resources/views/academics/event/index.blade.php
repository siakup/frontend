                                                ...
                                                input.addEventListener('input', function() {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                << << < HEAD document.querySelectorAll(
                                                                    '#sortDropdown .dropdown-item').forEach(item => {
                                                                    item.addEventListener('click', function() {
                                                                        sortDropdown.querySelectorAll(
                                                                            '.dropdown-item').forEach(
                                                                            i => i.classList.remove(
                                                                                'active'));
                                                                        const sortKey = this.getAttribute(
                                                                            'data-sort'); ===
                                                                        === =
                                                                        function sortTable(value) {
                                                                            $.ajax({
                                                                        ...
                                                                        sortTable(
                                                                        sortKey); // Panggil AJAX sortTable
                                                                    });
                                                                });
                                                                ...
                                                                document.addEventListener('click', function(e) {
                                                                    const btn = e.target.closest(
                                                                        '.btn-delete-event-academic');
                                                                    if (btn) {
                                                                        const idEvent = btn.getAttribute('data-id');
                                                                        document.getElementById(
                                                                                'modalKonfirmasiSimpan')
                                                                            .setAttribute('data-id', idEvent);
                                                                        document.getElementById(
                                                                                'modalKonfirmasiSimpan').style
                                                                            .display = 'flex';
                                                                    }
                                                                });
                                                                ...
                                                                document.getElementById('btnSimpan').addEventListener(
                                                                    ...
                                                                    function() {
                                                                        const id = document.getElementById(
                                                                            'modalKonfirmasiSimpan').getAttribute(
                                                                            'data-id');
                                                                        const csrfToken = document.querySelector(
                                                                            'meta[name="csrf-token"]').getAttribute(
                                                                            'content');
                                                                        $.ajax({
                                                                            url: "{{ route('academics-event.delete', ['id' => ':id']) }}"
                                                                                .replace(':id', id),
                                                                            method: 'DELETE',
                                                                            headers: {
                                                                ...
                                                                document.getElementById('btnCekKembali')
                                                                ...
                                                                sortBtn.addEventListener('click', function(e) {
                                                                    e.stopPropagation();
                                                                    sortDropdown.style.display = (sortDropdown.style
