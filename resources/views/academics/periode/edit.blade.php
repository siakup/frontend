    ...
    <form action="{{ route('academics-periode.update', ['id' => $id]) }}" method="POST">
      ...
      <x-container :class="'!gap-5 flex flex-col'">
        ...
        <x-container :variant="'content-wrapper'" :class="'flex flex-col gap-8 !px-0'">
            ...
            <x-container :variant="'content-wrapper'" :class="'!px-0 flex flex-row justify-between'">
              <x-form.input-container class="min-w-[150px]" id="semester">
            ...
            <x-container :variant="'content-wrapper'" :class="'!px-0 flex flex-row gap-5 justify-end'">
