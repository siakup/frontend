                ...
                <div class="form-group">
                    ...
                    <button id="toggleButton" type="button" class="btn-toggle">
                        <img src="{{ asset('components/toggle-off-disabled-true.svg') }}" alt="Toggle Icon"
                            id="toggleIcon">
                        <span class="toggle-info text-sm-bd" style="color: var(--Neutral-Gray-600, #8C8C8C)">Tidak
                            Aktif</span>
                    </button>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateSaveButtonState() {
                ...
                const startDateFilled = tanggalMulai.value !== '' && (tanggalMulaiInput.selectedDates[0] <
                    tanggalAkhirInput.selectedDates[0]);
                const endDateFilled = tanggalAkhir.value !== '' && (tanggalAkhirInput.selectedDates[0] >
