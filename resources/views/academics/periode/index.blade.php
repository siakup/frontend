<x-layouts.main>
    <x-layouts.content>
        ...
        <x-container.wrapper height="full" class="grid-rows-[auto_1fr]" width="full" cols="1">
                        ...
                        <x-container.container background="content-white" padding="p-4" class="items-center">
                            <x-container.wrapper rows="1" cols="2" height="fit" width="full">
                                ...
                                <x-container.container class="justify-end" >
                                    <x-filter-button class="rounded-md" />
                                </x-container.container>

                            </x-container.wrapper>
                        </x-container.container>
    
                        <x-container.container height="max" class="">
            ...
            <x-container.container width="full" padding="pt-4" class="justify-center">
                <x-pagination x-data="{
                    pagination: null,
                    requestData: null
                }"
        ...
        <x-modal.container-pure-js id="modalKonfirmasiHapus">
            <x-slot name="header">
                <x-container.container width="full" class="flex flex-row justify-between items-center !px-0 !ps-5 !gap-0">
                    ...
                    <x-icon name="delete/grey-24" class="w-8 h-8" />
                    </x-container>
            </x-slot>
