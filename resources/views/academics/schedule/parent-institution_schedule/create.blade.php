...
@section('title', 'Tambah Jadwal Kuliah Institusi Parent')
...
@section('content')
    <div class="page-header">
        <div class="page-title-text">Tambah Jadwal Kuliah Institusi Parent</div>
    </div>
    ...
    <form action="{{route('academics.schedule.parent-institution-schedule.store')}}" method="POST">
      @csrf
          ...
          <div class="form-section">
              ...
              <div class="form-group">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px]">
                      <input placeholder="Masukan Nama Kelas. Contoh: Makroekonomi-EC2" name="nama_kelas" type="text" id="Class-Name" class="!border-transparent focus:outline-none" value="">
                      <img class="clear hidden" src="{{asset('assets/icon-remove-text-input.svg')}}" alt="">
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px]">
                      <input placeholder="Masukan Nama Singkat. Contoh: EC2" name="nama_singkat" type="text" id="Slug-Class-Name" class="!border-transparent focus:outline-none" value="">
                      <img class="clear hidden" src="{{asset('assets/icon-remove-text-input.svg')}}" alt="">
                  </div>
              </div>
              <div class="form-group !flex justify-between">
                <div class="form-group w-full">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px]">
                      <input placeholder="Masukkan Kapasitas. Contoh: 50" name="kapasitas_peserta" type="text" id="Participant-Capacity" class="!border-transparent focus:outline-none" value="">
                      <img class="clear hidden" src="{{asset('assets/icon-remove-text-input.svg')}}" alt="">
                  </div>
                </div>
                <div class="form-group w-full">
