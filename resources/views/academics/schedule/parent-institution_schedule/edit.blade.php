...
<script type="module">
  ...
  document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('editParentInstitutionScheduleComponents', ParentInstitutionSchedule.editParentInstitutionScheduleComponents);
...
@section('content')
  <x-container 
    ...
    x-data='editParentInstitutionScheduleComponents()'
  >
    <x-typography :variant="'body-large-semibold'">Ubah Jadwal Kuliah Institusi Parent</x-typography>
    ...
    <x-modal.container-pure-js x-bind:class="{'hidden': !editConfirmationModalOpen, 'flex': editConfirmationModalOpen}">
      ...
      <x-slot name="footer">
        ...
        <x-button.primary x-on:click="onUpdateParentInstitutionSchedule">Ya, Simpan Sekarang</x-button.primary>
      </x-slot>
