...
@section('title', 'Ubah Jadwal Kuliah Institusi Parent')
          ...
          <div class="form-section">
                ...
                <div class="form-group w-full">
                  ...
                  <div class="filter-box" id="program_studi">
                      <button type="button" class="button-clean input" id="sortProgramStudi">
                          <span id="selectedEventLabel" class="text-black">{{current(array_filter($programStudiList, function ($programStudi) use($data) { return $programStudi->id == $data->id_prodi; }))->nama}}</span>
                          <img src="{{ asset('assets/icon-arrow-down-grey-20.svg') }}" alt="Filter">
                      </button>
              ...
              <div class="form-group w-full">
                ...
                <div class="filter-box" id="Periode">
                    <button type="button" class="button-clean input" id="sortPeriode">
                        <span id="selectedEventLabel" class="text-black">{{current(array_filter($periodeList, function ($periode) use($data) { return $periode->id == $data->id_periode_akademik; }))->tahun . '-' . current(array_filter($periodeList, function ($periode) use($data) { return $periode->id == $data->id_periode_akademik; }))->semester}}</span>
                        <img src="{{ asset('assets/icon-arrow-down-grey-20.svg') }}" alt="Filter">
                    </button>
              ...
              <div class="form-group !flex justify-between items-center">
                <div class="form-group items-center w-full">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px] !bg-[#F5F5F5]">
                      ...
                      <input placeholder="Pilih Mata Kuliah" name="matakuliah[id]" type="hidden" value="{{$data->id_mata_kuliah}}">
              ...
              <div class="form-group">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px]">
                      <input placeholder="Masukan Nama Kelas. Contoh: Makroekonomi-EC2" name="nama_kelas" value="{{$data->nama_jadwal}}" type="text" id="Class-Name" class="!border-transparent focus:outline-none" value="">
                      <img class="clear hidden" src="{{asset('assets/icon-remove-text-input.svg')}}" alt="">
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px]">
                      <input placeholder="Masukan Nama Singkat. Contoh: EC2" name="nama_singkat" type="text" id="Slug-Class-Name" class="!border-transparent focus:outline-none" value="{{$data->singkatan_jadwal}}">
                      <img class="clear hidden" src="{{asset('assets/icon-remove-text-input.svg')}}" alt="">
                  </div>
              </div>
              <div class="form-group !flex justify-between">
                <div class="form-group w-full">
                  ...
                  <div class="flex items-center border-[1px] border-[#D9D9D9] rounded-lg px-[12px]">
                      <input placeholder="Masukkan Kapasitas. Contoh: 50" name="kapasitas_peserta" type="text" id="Participant-Capacity" class="!border-transparent focus:outline-none" value="{{$data->jumlah_peserta}}">
                      <img class="clear hidden" src="{{asset('assets/icon-remove-text-input.svg')}}" alt="">
                  </div>
                </div>
                <div class="form-group w-full">
                  ...
                  <div class="filter-box" id="program_studi">
                      <button type="button" class="button-clean input" id="sortMBKMClass">
                          <span id="selectedEventLabel" class="text-black">{{$data->is_mbkm ? "Ya" : "Tidak"}}</span>
                          <img src="{{ asset('assets/icon-arrow-down-grey-20.svg') }}" alt="Filter">
                      </button>
                ...
                <x-table-body>
                  ...
                  <x-table-row>
                    ...
                    <x-table-cell>
                      ...
                      <input type="hidden" name="class_schedule[{{$key}}]['ruangan']" value="{{$class_schedule->id_ruangan}}" />
