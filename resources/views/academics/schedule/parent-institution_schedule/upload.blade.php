...
@section('title', 'Upload Jadwal Kuliah Institusi Parent')

@section('breadcrumbs')
    <div class="breadcrumb-item active">Upload Jadwal Kuliah Institusi Parent</div>
@endsection
...
@section('content')
    <div class="page-header">
        <div class="page-title-text">Upload Jadwal Kuliah Institusi Parent</div>
    </div>
    ...
    <div class="content-card">
        <div class="text-lg-bd title">
            <span>Impor Jadwal Kuliah Institusi Parent</span>
        ...
        <div class="upload-flex-row">
            <div class="upload-info-col">
                ...
                <a href="{{ route('academics.schedule.parent-institution-schedule.download-template', ['type' => 'xlsx']) }}">Unduh Sample Data (.xlsx)</a>
                <a href="{{ route('academics.schedule.parent-institution-schedule.download-template', ['type' => 'csv']) }}">Unduh Sample Data (.csv)</a>
            </div>
            <div class="upload-area">
                <div class="upload-area-title">Impor CSV Jadwal Kuliah Institusi Parent File</div>
                <div class="upload-card-and-buttons">
                    <form action="{{ route('academics.schedule.parent-institution-schedule.upload-result') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="content-inside-card">
            <div style="font-weight: 500; margin-bottom: 12px;">
                File yang diterima adalah file .csv dengan pemisah antar kolom berupa koma ","<br>
            ...
            <div class="text-md-rg" style="margin-top: 5%;">
                ...
                1,Rabu,14:00-14:30,GP2+GP2DD,"10103#Bahasa Inggris II","Harumi Manik Ayu Yamin",GP,2602,""<br>
            </div>
        </div>
