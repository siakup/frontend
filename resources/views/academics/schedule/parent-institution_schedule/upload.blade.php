...
<script type="module">
  ...
  document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('uploadParentInstitutionScheduleComponents', ParentInstitutionSchedule.uploadParentInstitutionScheduleComponents);
  });
</script>
...
@section('content')
  ...
  <x-modal.container-pure-js id="modalKonfirmasiBatal">
    ...
    <x-slot name="footer">
      ...
      <x-button.primary :href="route('academics.schedule.parent-institution-schedule.index')">Batalkan</x-button.primary>
    </x-slot>
