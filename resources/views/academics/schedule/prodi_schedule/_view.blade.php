...
<x-modal.container-pure-js id="modalViewProdi">
  <x-slot name="header">
    <x-container :variant="'content-wrapper'" :class="'flex flex-row justify-between items-center !px-0 !ps-5 !gap-0'">
      <x-typography :variant="'body-medium-bold'" :class="'flex-1 text-center'">Lihat Jadwal Kuliah Program Studi</x-typography>
      <x-button.base
        onclick="document.getElementById('modalViewProdi').remove();
  ...
  <x-slot name="body">
    ...
    >
      <x-container :class="'flex flex-col !gap-5'">
        <x-container :variant="'content-wrapper'" :class="'flex flex-row justify-between items-center !px-0 !ps-5 !gap-0'" x-on:click="toggleClassInformationSection = ! toggleClassInformationSection">
        ...
        <x-container :variant="'content-wrapper'" class="flex flex-col gap-4" x-bind:class="{'hidden': !toggleClassInformationSection, 'flex': toggleClassInformationSection}">
      ...
      <x-container :class="'flex flex-col !gap-5'">
        <x-container :variant="'content-wrapper'" :class="'flex flex-row justify-between items-center !px-0 !ps-5 !gap-0'" x-on:click="toggleLectureSection = ! toggleLectureSection">
        ...
        <x-container :variant="'content-wrapper'" class="flex flex-col gap-4 !p-0" x-bind:class="{'hidden': !toggleLectureSection, 'flex': toggleLectureSection}">
      ...
      <x-container :class="'flex flex-col !gap-5'">
        <x-container :variant="'content-wrapper'" :class="'flex flex-row justify-between items-center !px-0 !ps-5 !gap-0'" x-on:click="toggleScheduleSection = ! toggleScheduleSection">
        ...
        <x-container :variant="'content-wrapper'" class="flex flex-col gap-4 !p-0" x-bind:class="{'hidden': !toggleScheduleSection, 'flex': toggleScheduleSection}">
