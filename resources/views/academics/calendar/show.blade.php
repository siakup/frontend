              ...
              <tbody>
                @foreach($data as $d)
                  <tr>
                      ...
                      <td>
                        <div class="center">
                          <button class="btn-icon btn-edit-event-academic" data-id="{{ $d['id'] }}" title="Edit" type="button">
                              <img src="{{ asset('assets/icon-edit.svg') }}" alt="Edit">
                              <span>Ubah</span>
                          </button>
                          <button class="btn-icon btn-delete-event-academic" data-id="{{ $d['id'] }}" title="Delete" type="button">
                              <img src="{{ asset('assets/icon-delete-gray-600.svg') }}" alt="Delete">
                              <span>Hapus</span>
                          </button>
                          <button class="btn-icon" data-id="{{ $d['id'] }}" title="Delete" type="button">
                              <img src="{{ asset('assets/icon-sync.svg') }}" alt="Delete">
                              <span>Sync</span>
                          </button>
                        </div>
                      </td>
