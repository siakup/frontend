<div class="w-full h-36 grid grid-cols-12 grid-rows-3 bg-gradient-to-r from-white via-white to-[#FFECED]">
    <div class="col-start-1 col-end-4 row-span-3 grid grid-cols-6 grid-rows-3 items-center">
        <x-button x-on:click="$store.mainLayout.isOpen = !$store.mainLayout.isOpen" :variant="'tertiary'" :icon="'arrow-left/black-20'"
    ...
    <div class="col-start-7 col-end-10 row-span-3 px-10 py-7">
        <div class="flex items-start gap-2 p-2 border-[1px] border-[#D9D9D9] rounded-lg">
            <x-icon name="search/grey-32" alt="search" class="w-5 h-5 pointer-events-none" />
    ...
    <div class="col-start-10 col-end-12 row-span-3 grid grid-rows-2 w-full h-full gap-1">
        <div class="row-start-1 row-end-2 self-end flex items-center gap-3">
            <x-icon name="human/women" alt="Profile" width="40" />
    ...
    <div class="col-start-12 col-end-13 row-span-3 flex items-center gap-6">
        <x-icon name="notification/black-32" alt="Notifikasi" />
        <x-icon name="setting/black-32" alt="Pengaturan" />
    </div>
</div>
