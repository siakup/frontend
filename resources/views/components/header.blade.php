...
<x-container.container background="red-gradient" radius="none" class="h-fit" x-data="headerTime">
    <x-container.wrapper :cols="12" :padding="'p-0'" :radius="'none'">
        ...
        <x-container.container background="transparent" col="3" radius="none" class="h-full"
            x-bind:class="$store.mainLayout.isOpen ? '' : 'border-b border-b-gray-400'">
            <x-container.wrapper cols="6" rows="3">

                <x-button x-on:click="$store.mainLayout.isOpen = !$store.mainLayout.isOpen" :variant="'text-link'"
                    :icon="'arrow-left/black-32'" class="row-start-2 row-end-3 col-start-1 col-end-2" />
                ...
                <x-container.container :background="'transparent'" class="shrink-0 col-start-2 col-end-6 row-start-1 row-end-4">
                    <x-container.wrapper :padding="'p-0'" :rows="12" :align="'center'" :justify="'center'">
                        ...
                        <x-container.container :class="'row-start-11 row-end-13'">
                            <x-container.container :background="'transparent'" :gap="'gap-1'"
                                class="items-center justify-center">
                                <x-container.container :radius="'none'" :width="'maxContent'"
                ...
                <x-container.container :background="'transparent'"
                    class="col-start-6 col-end-7 row-start-1 row-end-4"></x-container.container>

            </x-container.wrapper>
        </x-container.container>

        <x-container.container background="transparent" radius="none"
            class="col-span-9 w-full h-full border-b border-gray-400">
            <x-container.wrapper :cols="12" :gap="3" :rows="6" :padding="'p-0'"
                :gapX="2">

                <x-container.container :background="'transparent'"
                    class="col-start-1 col-end-4 row-start-2 row-span-4 self-center">
                    <x-container.wrapper :rows="3" :padding="'p-0'" class="justify-start items-start">

                        <x-container.container :width="'auto'" :height="'auto'" :background="'transparent'"
                            class="row-start-1 self-end">
                            <x-typography :variant="'heading-h6'" tag="h6">Selamat Datang,
                                {{ explode(' ', session('nama'))[0] }}!</x-typography>
                        </x-container.container>
                ...
                <x-container.container :background="'transparent'"
                    class="col-start-5 col-end-9 row-start-2 row-end-4 items-center">
                    <x-form.search :value="''" :placeholder="'Cari'" :storeName="'headerComponents'" :storeKey="'datas'"
                        :requestRoute="route('home')" :responseKeyData="''" x-model="$store.headerComponents.search" />
                </x-container.container>

                <x-container.container :background="'transparent'"
                    class="col-start-9 col-end-11 row-start-2 row-span-4 gap-1 self-center">
                    <x-profile-header>
                ...
                <x-container.container :width="'auto'" :height="'auto'" :background="'transparent'"
                    class="col-start-11 col-end-12 row-start-2 row-span-4 self-center justify-self-center">
                    <x-icon :name="'notification/grey-32'" alt="Notification"></x-icon>
                </x-container.container>

                <x-container.container :width="'auto'" :height="'auto'" :background="'transparent'"
                    class="col-start-12 col-end-13 row-start-2 row-span-4 self-center justify-self-start">
