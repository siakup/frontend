<div 
  class="w-full h-36 grid grid-cols-12 grid-rows-3 bg-gradient-to-r from-white via-white to-[#FFECED]"
>
  <div class="col-start-1 col-end-4 row-span-3 grid grid-cols-6 grid-rows-3 items-center">
    <x-button x-on:click="$store.mainLayout.isOpen = !$store.mainLayout.isOpen" :variant="'tertiary'" :icon="asset('assets/icons/arrow-left/black-32.svg')" class="row-start-2 row-end-3 col-start-1 col-end-2" />
  ...
  <div class="col-start-4 col-end-7 row-span-3 grid grid-rows-3 justify-start items-start p-5">
    ...
    <div class="row-start-2 self-end">
      <x-typography :variant="'body-small-regular'">{{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd, D MMMM Y') }}</x-typography>
    </div>
  ...
  <div class="col-start-10 col-end-12 row-span-3 grid grid-rows-2 w-full h-full gap-1">
    <div class="row-start-1 row-end-2 self-end flex items-center gap-3">
      <img src="{{ asset('assets/icons/human/women.svg') }}" alt="Profile" width="40">
  ...
  <div class="col-start-12 col-end-13 row-span-3 flex items-center gap-6 ml-7.5">
    <img src="{{ asset('assets/icons/notification/black-32.svg') }}" alt="Notifikasi" width="20">
    <img src="{{ asset('assets/icons/setting/black-32.svg') }}" alt="Pengaturan" width="20">
  </div>
</div>