    ...
    <nav class="flex-1 overflow-y-auto h-[calc(100vh-169px-56px)] scroll-thin">
        <x-menu.container :variant="'main'">
          <x-menu.item
            :label="'Beranda'"
            :haveIcon="true"
            :icon="asset('assets/icons/dashboard/black-32.svg')"
            :routeName="'home'"
            :routeQuery="'home'"
            :variant="'parent'"
          />
          ...
          <x-menu.item
            :label="'Konfigurasi'"
            :haveIcon="true"
            :icon="asset('assets/icons/admin/black-32.svg')"
            :routeName="''"
            :variant="'parent'"
          ...
          <x-menu.item
            :label="'Kurikulum'"
            :haveIcon="true"
            :icon="asset('assets/icons/curriculum/outline-black-32.svg')"
          ...
          <x-menu.item
            :label="'Mata Kuliah'"
            :haveIcon="true"
            :icon="asset('assets/icons/course/outline-black-32.svg')"
          ...
          <x-menu.item
            ...
            :haveIcon="true"
            :icon="asset('assets/icons/advisory/black-32.svg')"
