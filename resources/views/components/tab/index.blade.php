...
@php
    ...
    if ($variant === 'underline') {
        $containerClasses = "w-full grid grid-flow-col auto-cols-fr gap-0 relative -bottom-px z-20" . $containerClass;
        ...
        $itemClasses = 'w-full py-2.5 px-8 text-center inline-flex justify-center ' . $baseLinkClasses;
