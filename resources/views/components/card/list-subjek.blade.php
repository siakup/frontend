...
<x-container.wrapper :rows="4" :gapY="1" :padding="'p-0'" width="maxContent">
    ...
    <x-container.container class="row-start-2 row-end-3 items-center">
        <x-typography :variant="'body-medium-semibold'" class="text-blue-500">{{ $subjek }}</x-typography>
    </x-container.container>
    <x-container.container class="row-start-3 row-end-4 flex flex-row items-center">
    ...
    <x-container.container class="row-start-4 row-end-5">
