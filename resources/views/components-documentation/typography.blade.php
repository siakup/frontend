...
@section('content')
<x-container :variant="'content-wrapper'" class="">
  ...
  <x-container class="h-30 !px-0 shadow-high !border-none">Shadow High</x-container>
  <x-container class="h-30 !px-0 shadow-medium !border-none">Shadow Medium</x-container>
  <x-container class="h-30 !px-0 shadow-low !border-none">Shadow Low</x-container>
  <x-container class="h-30 !px-0 shadow-high-inverse !border-none">Shadow High Inverse</x-container>
  <x-container class="h-30 !px-0 shadow-medium-inverse !border-none">Shadow Medium Inverse</x-container>
  <x-container class="h-30 !px-0 shadow-low-inverse !border-none">Shadow Low Inverse</x-container>

  <x-typography :variant="'heading-h5'">Radius</x-typography>
  <x-container class="h-30 !px-0 !rounded-sm !border-none">Radius SM</x-container>
  <x-container class="h-30 !px-0 !border-none">Radius MD</x-container> {{-- DEFAULT rounded-md --}}
  <x-container class="h-30 !px-0 !rounded-lg !border-none">Radius LG</x-container>
