...
<x-container :variant="'content-wrapper'">
    ...
    <form action="{{route('curriculum.list.edit.assign-study', ['id' => $id])}}" method="GET">
      ...
      <x-container :variant="'content-wrapper'" :class="'!px-0'">
       <x-form.input-container :class="'min-w-[130px]'">
        ...
        <x-container :variant="'content-wrapper'" class="flex flex-row w-full justify-end !px-0">
          <x-button.secondary 
            type="button" 
            id="btnBatal"
          >
  ...
  @csrf
  <x-container :class="'border-none flex flex-col gap-4'">
      <x-table>
          <x-table-head>
              <x-table-row>
                  ...
                  <x-table-header class="cursor-pointer">Jumlah SKS</x-table-header>
