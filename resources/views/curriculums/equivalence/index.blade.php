            ...
            <div class="card-header option-list">
                ...
                <div class="card-header" id="StudyProgramSection">
                    ...
                    @include('partials.dropdown-filter', [
                        ...
                        'label' =>
                            count(array_filter($programStudiList, function ($item) use ($id_prodi) {
                                    return $item->id == $id_prodi;
                                })) > 0
                                ? array_values(array_filter($programStudiList, function ($item) use ($id_prodi) {
                                        return $item->id == $id_prodi;
                                    }))[0]->nama
                                : '',
                        'url' => route('curriculum.list'),
                                    ...
                                    <x-table-cell>
                                        <div class="center">
                                            ...
                                            <a class="btn-icon btn-edit-periode-academic" title="Ubah"
                                                href="{{ route('curriculum.equivalence.edit', ['id' => 1]) }}"
