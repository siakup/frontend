<div class="navigation-card">
    ...
    <a href="{{ route('tutelage-group.student-list.detail-transkrip-pem', ['id' => $id]) }}" class="item @if (Route::currentRouteName() === 'tutelage-group.student-list.detail-transkrip-pem') active @endif">Transk. PEM</a>
</div>
