    ...
    <div class="content-card">
        ...
        <div class="content-inside-card">
            ...
            <ul style="text-sm-rg-red">
                ...
                <li>jenis: jenis mata kuliah, pilih salah satu dari Mata Kuliah Dasar Teknik, Mata Kuliah Dasar Umum, Mata Kuliah Program Studi, Mata Kuliah Sains Dasar, Mata Kuliah Universitas Pertamina*)</li>
                ...
                <li>*) regured, ika ma kliai nsongi, ika ad ulang akan menganti data sebelumnya, prasyarat mata kuliah hanya 1</li>
            </ul>
